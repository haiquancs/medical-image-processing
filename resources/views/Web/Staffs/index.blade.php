...
@section('content')
    ...
    <link rel="stylesheet" href="{{asset('css/web/cornerstone.min.css')}}">
...
<script src="{{asset('js/web/charLS-FixedMemory-browser.js')}}"></script>
<script src="{{asset('js/web/cornerstone.min.js')}}"></script>
<script src="{{asset('js/web/cornerstoneMath.min.js')}}"></script>
<script src="{{asset('js/web/cornerstoneTools.min.js')}}"></script>
<script src="{{asset('js/web/dicomParser.min.js')}}"></script>
<script src="{{asset('js/web/initializeWebWorkers.js')}}"></script>
<script src="{{asset('js/web/jpeg.js')}}"></script>
<script src="{{asset('js/web/jpegLossless.js')}}"></script>
<script src="{{asset('js/web/openJPEG-FixedMemory.js')}}"></script>
<script src="{{asset('js/web/pako.min.js')}}"></script>
<script src="{{asset('js/web/uids.js')}}"></script>
